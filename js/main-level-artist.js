...
const mainLevelArtist = getElementFromTemplate(`  <!-- Выбор исполнителя: уровень -->
 ...
 */
const inputAnswerList = mainLevelArtist.querySelectorAll(`.main-answer-wrapper`);
for (const inputAnswer of inputAnswerList) {
  inputAnswer.addEventListener(`click`, () => showWindow(mainLevelGenre));
}
